...
rm -f "$run_dir/find-best-rec-signal-p2-all.bin"
rm -f "$run_dir/ufdist-v1.bin"
rm -f "$run_dir/super-dist-p-v1.bin"
rm -f "$run_dir/super-dist-p-calls.bin"
rm -f "$run_dir/super-dist-p-inputs.bin"
rm -f "$run_dir/super-dist-p-rows.bin"
rm -f "$run_dir/super-dist-p2-v1.bin"
rm -f "$run_dir/check-matrix-p-v1.bin"
rm -f "$run_dir/make-nj-trees-p2-v1.bin"
rm -f "$run_dir/make-nj-trees-p2-v2.bin"
...
test -s "$run_dir/find-best-rec-signal-p2-all.bin"
test -s "$run_dir/ufdist-v1.bin"
test -s "$run_dir/super-dist-p-v1.bin"
test -s "$run_dir/super-dist-p-calls.bin"
test -s "$run_dir/super-dist-p-inputs.bin"
test -s "$run_dir/super-dist-p-rows.bin"
test -s "$run_dir/super-dist-p2-v1.bin"
test -s "$run_dir/check-matrix-p-v1.bin"
test -s "$run_dir/make-nj-trees-p2-v1.bin"
test -s "$run_dir/make-nj-trees-p2-v2.bin"
...
echo "captured $run_dir/super-dist-p-calls.bin ($(stat -c %s "$run_dir/super-dist-p-calls.bin") bytes)"
echo "captured $run_dir/super-dist-p-inputs.bin ($(stat -c %s "$run_dir/super-dist-p-inputs.bin") bytes)"
echo "captured $run_dir/super-dist-p-rows.bin ($(stat -c %s "$run_dir/super-dist-p-rows.bin") bytes)"
...
echo "captured $run_dir/make-nj-trees-p2-v2.bin ($(stat -c %s "$run_dir/make-nj-trees-p2-v2.bin") bytes)"
